 ...
 * http://www.fhir.org/guides/argonaut/pd/StructureDefinition-argo-practitionerrole.html for
...
public class PractitionerRoleController {
  ...
  private PractitionerRole.Bundle bundle(MultiValueMap<String, String> parameters, int page, int count) {
  ...
  public PractitionerRole.Bundle searchBySpecialty(
      ...
      @RequestParam(value = "_count", defaultValue = "1") @Min(0) int count) {
    return bundle(
        Parameters.builder().add("specialty", specialty).add("page", page).add("_count", count).build(),
        page,
        count);
  }
  ...
  public interface Transformer
      extends Function<PractitionerRole, PractitionerRole> {}
